...
// https://github.com/gee1k/uPic/blob/ac0c06b33501dedf940814a144771429a9c813a0/uPic/Views/HistoryRecord/HistoryThumbnailFlowLayout.swift
@objc public protocol WaterfallFlowLayoutDelegate: NSCollectionViewDelegate {
...
public class WaterfallFlowLayout: NSCollectionViewLayout {
    ...
    private weak var delegate: WaterfallFlowLayoutDelegate?  {
        get {
            return collectionView?.delegate as? WaterfallFlowLayoutDelegate
        }
    }
    ...
    public override func prepare() {
        ...
        for section in 0..<numberOfSections {
            ...
            if headerHeight > 0 {
                attributes = NSCollectionViewLayoutAttributes(forSupplementaryViewOfKind: NSCollectionView.elementKindSectionHeader, with: NSIndexPath(forItem: 0, inSection: section) as IndexPath)
            ...
            if footerHeight > 0 {
                attributes = NSCollectionViewLayoutAttributes(forSupplementaryViewOfKind: NSCollectionView.elementKindSectionFooter, with: NSIndexPath(forItem: 0, inSection: section) as IndexPath)
...
private extension WaterfallFlowLayout {
